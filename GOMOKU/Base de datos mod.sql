...
-- Volcando estructura de base de datos para gomoku
CREATE DATABASE IF NOT EXISTS `gomoku` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `gomoku`;

-- Volcando estructura para tabla gomoku.jugadores
CREATE TABLE IF NOT EXISTS `jugadores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) NOT NULL,
  `jugando` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Volcando estructura para tabla gomoku.partida
