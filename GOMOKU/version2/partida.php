...
if($_SESSION["Numero_Jugador"] == 1 && $_SESSION["VecesBotonJugador1"] == 0 )
    MostrarBoton();
...
if($_SESSION["Partida_Entrando"] == 0){// Para la primera vez que entro
    ...
    else if($_SESSION["Numero_Jugador"] == 1 && $_SESSION["VecesBotonJugador1"] != 0 || $_SESSION["Numero_Jugador"] == 2) echo "<script>setTimeout('window.open(\"partida.php\",\"_self\")', 1000);</script>"; // recargo
}
...
if(isset($_POST["Fila"]) && isset($_POST["Columna"])){ // si he puesto casilla el procedimiento de actualizar los datos 
    ...
    if($Fila == 7 && $Columna == 7 && $_SESSION["VecesBotonJugador1"] == 0 && $_SESSION["Numero_Jugador"] == 1){
            echo "la primera no se puede en el centro";
    }
    else if(comprobarCasillasVacias($_SESSION["TableroFichas"],$Fila,$Columna)){
